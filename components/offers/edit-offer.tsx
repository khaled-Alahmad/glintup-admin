...
import { ArrowLeft, Upload, Percent, ArrowRight } from "lucide-react"
...
export default function EditOffer({ offerId }: EditOfferProps) {
  ...
  // في تطبيق حقيقي، ستقوم بجلب بيانات العرض بناءً على offerId
  useEffect(() => {
    // محاكاة جلب البيانات
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    toast({
      ...
      description: "تم تحديث بيانات العرض في النظام",
    })
  }
  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex items-center gap-4">
        ...
        <h1 className="text-2xl md:text-3xl font-bold tracking-tight">تعديل العرض</h1>
      </div>
      ...
      <form onSubmit={handleSubmit}>
        <Card>
          <CardHeader>
            ...
            <CardDescription>تعديل معلومات العرض</CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <Input id="title" defaultValue="خصم 25% على جميع الخدمات" required />
              </div>
              <div className="space-y-2">
                <Label htmlFor="salon">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input id="discount" type="number" defaultValue="25" className="pr-9" required />
                </div>
              </div>
              <div className="space-y-2">
                <Label htmlFor="code">
                ...
                <Input id="code" defaultValue="SUMMER25" required />
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <Input id="max-usage" type="number" defaultValue="100" required />
              </div>
              <div className="space-y-2">
          ...
          <CardFooter className="flex justify-between">
            <Button variant="outline" type="button" asChild>
              <Link href={`/offers/${offerId}`}>إلغاء</Link>
            </Button>
