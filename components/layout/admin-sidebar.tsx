  ...
  return (
    <div className="flex h-full w-full flex-col bg-sidebar overflow-y-auto">
      <div className="flex h-16 shrink-0 items-center border-b border-sidebar-border px-6">
        {mobile && (
          <Button variant="ghost" size="icon" onClick={onClose} className="mr-auto text-sidebar-foreground">
            <X className="h-5 w-5" />
        ...
        <div className="flex items-center gap-2 font-semibold text-xl">
          ...
          <span className="text-sidebar-foreground/70 text-sm">لوحة التحكم</span>
        </div>
      </div>
      ...
      <div className="border-t border-sidebar-border p-4">
        <p className="text-xs text-sidebar-foreground/70">نسخة 1.0.0 - جميع الحقوق محفوظة © 2023</p>
      </div>
    </div>
  )
}
